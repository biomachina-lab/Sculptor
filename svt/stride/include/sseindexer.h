#ifndef __SSEINDEXER_H
#define __SSEINDEXER_H
...
#define ST_IN(x, target, range)      ( (x >= (target - range)) && (x <= (target + range)) )
...
enum MGROUP  {Peptide, Trp, Asn, Gln, Arg, His, Lys, Ser, Thr, Tyr, Asp, Glu, Met, Cys};
...
typedef struct {
		 ...
		 BOOLEAN MolScript, OutSeq, Stringent, Measure;
