...
#ifndef __SVT_SHADER_CG_VOLUME_H
#define __SVT_SHADER_CG_VOLUME_H

#include <svt_shader_cg.h>
#include <svt_vector3.h>
#include <svt_matrix4.h>

class DLLEXPORT svt_shader_cg_volume : public svt_shader_cg
{
protected:
