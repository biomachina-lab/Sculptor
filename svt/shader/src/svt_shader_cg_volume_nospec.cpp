...
\n\
        ...
        OUT.color.rgb = (OUT.color.rgb*fDiffuse) + (OUT.color.rgb*Ambient);\n\
        return OUT;\n\
}\n\
\n\
";
 ...
 * Constructor
 */
svt_shader_cg_volume_nospec::svt_shader_cg_volume_nospec() : svt_shader_cg(false, g_pVolRenVertNS, g_pVolRenFragNS )
//svt_shader_cg_volume_nospec::svt_shader_cg_volume_nospec() : svt_shader_cg(true, "svt_shader_cg_volume_nospec_vert.cg", "svt_shader_cg_volume_nospec_frag.cg" )
{
 ...
 */
void svt_shader_cg_volume_nospec::setStateVertParams()
{
    if (m_bVertex && m_pVertProfile != CG_PROFILE_UNKNOWN)
    {
 ...
 * set the current state of parameters
 */
void svt_shader_cg_volume_nospec::setStateFragParams()
{
    if (m_bFragment && m_pFragProfile != CG_PROFILE_UNKNOWN)
    {
 ...
 */
void svt_shader_cg_volume_nospec::setVolumeID(int iVolumeID)
{
 ...
 */
void svt_shader_cg_volume_nospec::setTransferID(int iTransferID)
{
 ...
 */
void svt_shader_cg_volume_nospec::setSliceDistance(float fSliceDistance)
{
 ...
 */
void svt_shader_cg_volume_nospec::setLightPosition(svt_vector3<Real32> vLightPosition)
{
 ...
 */
void svt_shader_cg_volume_nospec::setModelViewMatrix(svt_matrix4<Real32> oModelView)
{
 ...
 */
void svt_shader_cg_volume_nospec::setLightingParams( Real32 fDiffuse, Real32 fAmbient )
{
    m_fDiffuse = fDiffuse;
    m_fAmbient = fAmbient;
};
