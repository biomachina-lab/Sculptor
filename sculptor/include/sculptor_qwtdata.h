...
#ifndef __SCULPTOR_QWTDATA_H
#define __SCULPTOR_QWTDATA_H
 ...
 * QwtPlot. Using STL vectors makes it easy, flexible and safe.
 * \author Manuel Wahle
 */
class sculptor_qwtdata : public QwtData
{
...
public:
     ...
     */
    sculptor_qwtdata(int iSize);

    /**
     * Constructor
     * \int iSize initial size. will be reserved in the vectors
     * \param vector<double> for the x-coord. values will be copied
     * \param vector<double> for the y-coord. values will be copied
     */
    sculptor_qwtdata(int iSize, vector<double>& oX, vector<double>& oY);

    /**
     * Constructor
     * \int iSize initial size. will be reserved in the vectors
     * \param pX pointer to an array with Real64s. values will be copied
     * \param pY pointer to an array with Real64s. values will be copied
     */
    sculptor_qwtdata(int iSize, Real64* pX, Real64* pY);

    /**
     * Destructor
     */
    virtual ~sculptor_qwtdata();
